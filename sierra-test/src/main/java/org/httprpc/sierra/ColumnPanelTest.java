...
public class ColumnPanelTest extends JFrame implements Runnable {
    private ColumnPanelTest() {
        super("Column Panel Test");
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new ColumnPanelTest());
    }
}

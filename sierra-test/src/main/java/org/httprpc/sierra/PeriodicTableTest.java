    ...
    public void run() {
        setContentPane(column(4,
            ...
            row(4,
                ...
                cell(new ElementPanel()),
                cell(new ElementPanel()),
                cell(new ElementPanel(13, "Al", Group.POST_TRANSITION_METAL)),
                cell(new ElementPanel(14, "Si", Group.METALLOID)),
                cell(new ElementPanel(15, "P", Group.REACTIVE_NONMETAL)),
                cell(new ElementPanel(16, "S", Group.REACTIVE_NONMETAL)),
                cell(new ElementPanel(17, "Cl", Group.REACTIVE_NONMETAL)),
            ...
            row(4,
                ...
                cell(new ElementPanel(30, "Zn", Group.POST_TRANSITION_METAL)),
                cell(new ElementPanel(31, "Ga", Group.POST_TRANSITION_METAL)),
                cell(new ElementPanel(32, "Ge", Group.METALLOID)),
                cell(new ElementPanel(33, "As", Group.METALLOID)),
                cell(new ElementPanel(34, "Se", Group.REACTIVE_NONMETAL)),
                cell(new ElementPanel(35, "Br", Group.REACTIVE_NONMETAL)),
            ...
            row(4,
                ...
                cell(new ElementPanel(48, "Cd", Group.POST_TRANSITION_METAL)),
                cell(new ElementPanel(49, "In", Group.POST_TRANSITION_METAL)),
                cell(new ElementPanel(50, "Sn", Group.POST_TRANSITION_METAL)),
                cell(new ElementPanel(51, "Sb", Group.METALLOID)),
                cell(new ElementPanel(52, "Te", Group.METALLOID)),
                cell(new ElementPanel(53, "I", Group.REACTIVE_NONMETAL)),
            ...
            row(4,
                ...
                cell(new ElementPanel(80, "Hg", Group.POST_TRANSITION_METAL)),
                cell(new ElementPanel(81, "Tl", Group.POST_TRANSITION_METAL)),
                cell(new ElementPanel(82, "Pb", Group.POST_TRANSITION_METAL)),
                cell(new ElementPanel(83, "Bi", Group.POST_TRANSITION_METAL)),
                cell(new ElementPanel(84, "Po", Group.POST_TRANSITION_METAL)),
                cell(new ElementPanel(85, "At", Group.METALLOID)),
            ...
            row(4,
                ...
                cell(new ElementPanel(109, "Mt", Group.UNKNOWN)),
                cell(new ElementPanel(110, "Ds", Group.UNKNOWN)),
                cell(new ElementPanel(111, "Rg", Group.UNKNOWN)),
                cell(new ElementPanel(112, "Cn", Group.POST_TRANSITION_METAL)),
                cell(new ElementPanel(113, "Nh", Group.UNKNOWN)),
                cell(new ElementPanel(114, "Fl", Group.UNKNOWN)),
                cell(new ElementPanel(115, "Mc", Group.UNKNOWN)),
                cell(new ElementPanel(116, "Lv", Group.UNKNOWN)),
                cell(new ElementPanel(117, "Ts", Group.UNKNOWN)),
                cell(new ElementPanel(118, "Og", Group.UNKNOWN))
            ),
            row(4,
                cell(new ElementPanel()),
                cell(new ElementPanel()),
            ...
            row(8,
                ...
                cell(new KeyPanel("Post-transition metal", Group.POST_TRANSITION_METAL)),
                cell(new KeyPanel("Metalloid", Group.METALLOID)),
                cell(new KeyPanel("Reactive nonmetal", Group.REACTIVE_NONMETAL)),
                cell(new KeyPanel("Noble gas", Group.NOBLE_GAS)),
                cell(new KeyPanel("Unknown", Group.UNKNOWN)),
                glue()
            )

...
The first argument represents either the path to the directory where the DTD will be created or to a properties file containing the custom bindings. Keys represent markup tags, and values are the fully qualified class names to which the tags will be bound. For example:

...
In addition to the layout management features discussed above, Sierra also provides support for some common user interface elements that are not included in the standard Swing library.

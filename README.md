...
A resource bundle may optionally be provided as the third argument to `UILoader#load()`. When specified, attributes representing string values are considered resource keys and are used to look up the associated values in the bundle.
